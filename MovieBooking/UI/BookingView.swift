...
//  MovieBooking
//
//  Created by Guilherme on 08/08/23.
//
        ...
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 0.0) {
                    ...
                    Text("Dr. Stephan Strange casts a forbidden spell that opens the doorway to the multiverse, incluiding alternate versions of...")
                        .font(.headline)
                        .foregroundColor(.white)
                        .padding(30)
